...
-- ----------------------------
-- Table structure for regla
-- ----------------------------
DROP TABLE IF EXISTS `regla`;
CREATE TABLE `regla` (
  `id_regla` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Records of regla
-- ----------------------------
INSERT INTO `regla` VALUES ('1', 'No Causar faltas', 'ACTIVO');
INSERT INTO `regla` VALUES ('5', 'reglax', 'INACTIVO');
...
-- Records of usuario
-- ----------------------------
INSERT INTO `usuario` VALUES ('admin', '5f4dcc3b5aa765d61d8327deb882cf99', 'SI', 'NO', '2017-06-06 15:42:42', '0', 'NO', null);
